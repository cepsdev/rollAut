...
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1100,0,100,0,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2100,1,100,1,"timeout=30;","timeout=60;");


insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1101,0,101,10,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2101,1,101,9,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(3101,2,101,8,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(4101,3,101,7,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(5101,4,101,6,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(6101,5,101,5,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(7101,6,101,4,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(8101,7,101,3,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(9101,8,101,2,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(10101,9,101,1,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(11101,10,101,0,"timeout=30;","timeout=60;");


insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1103,0,103,0,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2103,1,103,1,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(3103,2,103,2,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(4103,3,103,3,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(5103,4,103,4,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(6103,5,103,5,"timeout=30;","timeout=60;");

insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1104,0,104,0,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2104,10,104,1,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(3104,1,104,2,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(4104,9,104,3,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(5104,2,104,4,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(6104,8,104,5,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(7104,3,104,6,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(8104,7,104,7,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(9104,4,104,8,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(10104,5,104,9,"timeout=30;","timeout=60;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(11104,6,104,10,"timeout=30;","timeout=60;");

insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1105,6,105,0,"timeout=30;","timeout=60;");
