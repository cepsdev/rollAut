...
insert INTO rollout_step_type (id,description,job_check,job_run,job_check_warn,job_run_warn,job_run_error) values(2,"Service Discovers","job_check_2","job_run_2","job_check_warn_2","job_run_warn_2","job_run_error_2");
