...
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1200,0,101,0,"timeout=40;","timeout=120;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2200,1,101,1,"timeout=40;","timeout=120;");

insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(1300,0,102,0,"timeout=40;","timeout=120;");
insert into rollout_step (id,step_type,rollout,sequence,warn,error) values(2300,1,102,1,"timeout=40;","timeout=120;");

delete from rollout;
insert INTO rollout (id,name,start) values(100,"rollout-2-steps-critical-in60s (A)",DATE_ADD(NOW(),INTERVAL 480 MINUTE));
